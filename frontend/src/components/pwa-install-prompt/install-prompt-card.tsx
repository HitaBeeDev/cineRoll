  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed inset-x-3 bottom-3 z-[70] mx-auto max-w-md rounded-2xl border border-edge-strong bg-[#0d0d1a]/97 p-5 shadow-[0_20px_60px_rgba(0,0,0,0.6)] backdrop-blur-md"
      ...
      >
        <button
          ...
          onClick={onClose}
          aria-label="Close"
          className="absolute right-3 top-3 rounded-full p-1 text-[#8a8a9e] transition-colors hover:bg-white/5 hover:text-fg-hi focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40"
        >
        ...
        <div className="flex items-center gap-4 pr-6">
          <div className="shrink-0 overflow-hidden rounded-2xl border border-edge bg-ink-900 shadow-[0_8px_24px_rgba(0,0,0,0.5)]">
            <Image src="/icon-192.png" alt="CineRoll" width={56} height={56} className="h-14 w-14" />
          </div>
          <div className="min-w-0">
            <p className="font-[family-name:var(--font-geist-mono)] text-[10px] uppercase tracking-[0.28em] text-accent/80">
              {"// install"}
            </p>
            <h2 className="mt-1 font-[family-name:var(--font-display)] text-xl font-bold leading-tight text-fg-hi">
