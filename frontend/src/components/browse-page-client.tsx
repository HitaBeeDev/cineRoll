    ...
    >
      ...
      <main className="mx-auto w-full max-w-[100vw] flex-1 px-4 py-6 sm:max-w-screen-2xl sm:px-6 sm:py-8 lg:px-8 xl:px-12">
        ...
        >
          ...
          {/* Roll + Sort form one right-hand cluster, so the header reads as two
              balanced groups (count | actions) rather than three items with Roll
              floating in the middle and crowding the row at the lg breakpoint. */}
          <div className="flex w-full flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-end sm:gap-3 lg:w-auto lg:flex-nowrap lg:gap-4">
            {/* Roll is the product's signature, so its entry point is always
                present — unfiltered it rolls the whole corpus ("Roll a random
                film"); once filtered it rolls from the matching set. */}
            <button
              type="button"
            ...
            <div className="flex w-full items-center gap-2 sm:w-auto">
              ...
              <FilterSelect
                ...
                className="w-full min-w-[140px] text-[12px] text-[#e8e5f4] sm:w-[150px]"
