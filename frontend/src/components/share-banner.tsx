...
export function ShareBanner() {
  ...
  return (
    <div className="relative z-50 flex items-center justify-between gap-4 border-b border-accent/20 bg-accent/8 px-4 py-2.5 backdrop-blur-sm sm:px-6">
      ...
      <div className="flex shrink-0 items-center gap-4">
        <Link
          href="/"
          className="font-[family-name:var(--font-geist-mono)] text-[11px] uppercase tracking-[0.3em] text-accent transition-opacity hover:opacity-75"
        >
          Discover more →
        </Link>
        <button
