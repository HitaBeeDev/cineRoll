  ...
  return (
    <div className="group/slider relative select-none" ref={containerRef}>
      ...
      <button
        ...
        disabled={index === 0}
        aria-label="Previous"
        className="absolute bottom-0 left-0 top-0 z-10 flex w-12 items-center justify-center bg-gradient-to-r from-[#07070b] via-[#07070b]/60 to-transparent text-[#6a6a82] opacity-70 transition-opacity duration-200 hover:text-fg-hi group-hover/slider:opacity-100 disabled:!opacity-0"
      >
      ...
      <button
        ...
        aria-label="Next"
        className="absolute bottom-0 right-0 top-0 z-10 flex w-12 items-center justify-center bg-gradient-to-l from-[#07070b] via-[#07070b]/60 to-transparent text-[#6a6a82] opacity-70 transition-opacity duration-200 hover:text-fg-hi group-hover/slider:opacity-100 disabled:!opacity-0"
      >
