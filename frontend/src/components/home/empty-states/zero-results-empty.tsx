    ...
    <EmptyStateShell glowOpacity={0.08}>
      ...
      >
        ...
        <motion.div variants={itemVariants} className="relative">
          <Film
            className="h-16 w-16 text-accent/15"
            strokeWidth={1}
            aria-hidden
          />
        ...
        <motion.p
          ...
          className="font-[family-name:var(--font-geist-mono)] text-[11px] uppercase tracking-[0.4em] text-accent/70"
        >
          ◈ No Matches ◈
        </motion.p>
        ...
        <motion.div variants={itemVariants} className="flex flex-col gap-0.5">
          <h2 className="font-[family-name:var(--font-display)] text-[2.4rem] font-bold leading-tight">
            <span className="block text-fg-hi">Nothing in</span>
            <span className="block text-accent">the reel.</span>
          </h2>
        </motion.div>
        ...
        >
          <button
            type="button"
            onClick={onClear}
            className="rounded-xl bg-accent px-6 py-2.5 font-[family-name:var(--font-geist-mono)] text-[11px] uppercase tracking-[0.2em] text-white transition-opacity hover:opacity-90"
          >
            Clear all filters
          </button>
          <button
            ...
            className="font-[family-name:var(--font-geist-mono)] text-[11px] uppercase tracking-widest text-[#888899] underline-offset-4 transition-colors hover:text-fg-hi hover:underline"
          >
