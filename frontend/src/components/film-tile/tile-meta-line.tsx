  ...
  return (
    <div className="mt-1.5 flex flex-col gap-1">
      <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
        {contentType && (
          <span className="rounded-[3px] border border-white/25 bg-white/[0.07] px-1.5 py-[2px] font-[family-name:var(--font-geist-mono)] text-[10px] uppercase tracking-[0.16em] text-[#dcdce6]">
            {contentType}
          </span>
        )}
        <p className="font-[family-name:var(--font-geist-mono)] text-[11px] text-[#9d98ad]">
          {facts}
        </p>
      </div>
      ...
      {genres && (
        <p className="line-clamp-2 font-[family-name:var(--font-geist-mono)] text-[11px] text-[#8d879d]">
          {genres}
        </p>
      )}
    </div>
