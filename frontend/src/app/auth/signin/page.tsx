        ...
        <div className="w-full min-w-0 max-w-sm">
          <section className="min-w-0 overflow-hidden rounded-2xl border border-white/10 bg-[#0d0d16]/72 p-5 shadow-[0_24px_90px_rgba(0,0,0,0.36)] backdrop-blur sm:p-6">
            ...
            <p className="mt-4 border-t border-white/10 pt-3 text-center text-xs leading-5 text-[#8f8fa0]">
              ...
              <Link href="/terms" className="text-[#c8c8d4] underline-offset-2 transition-colors hover:text-fg-hi hover:underline">
                Terms
              </Link>{" "}
              and{" "}
              <Link href="/privacy" className="text-[#c8c8d4] underline-offset-2 transition-colors hover:text-fg-hi hover:underline">
                Privacy
              </Link>
              .{" "}
              <Link href="/help" className="text-[#c8c8d4] underline-offset-2 transition-colors hover:text-fg-hi hover:underline">
                Need help?
              </Link>
            </p>
          </section>
