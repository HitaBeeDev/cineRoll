...
export function HomeHero() {
  return (
    <h1 className="font-[family-name:var(--font-display)] font-bold leading-[1.05] tracking-tight text-fg-hi transition-all duration-300">
      One spin.
      <br />
      <span className="text-accent">One film.</span>
      <br />
      Tonight.
    </h1>
  );
