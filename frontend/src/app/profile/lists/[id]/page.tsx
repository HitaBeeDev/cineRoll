          ...
          <>
            ...
            <div className="mt-8">
              {result.films.length === 0 ? (
                <div className="flex flex-col items-center gap-3 rounded-xl border border-dashed border-edge bg-[#0d0d1a] px-6 py-16 text-center">
                  ...
                  <Link
                    href="/browse"
                    className="mt-1 inline-flex items-center rounded font-[family-name:var(--font-geist-mono)] text-[11px] uppercase tracking-[0.2em] text-[#9a9aac] underline-offset-4 transition-colors hover:text-accent hover:underline"
                  >
                    Browse films
                  </Link>
                </div>
