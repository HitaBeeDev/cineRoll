...
/**
 * Instant navigation feedback for the watchlist route. Without this, a
 * force-dynamic page leaves the previous screen frozen until the (remote,
 * ~1s) server render resolves — so a dropdown click feels like it did nothing.
 * Mirrors the page's shell + poster grid so there's no layout jump.
 */
