...
export function FilmCarouselViewport(props: FilmCarouselViewportProps) {
  ...
  return (
    <div
      ...
      className="relative flex min-h-0 flex-1 cursor-grab touch-pan-y select-none gap-3 rounded-lg outline-none focus-visible:ring-2 focus-visible:ring-accent/40 active:cursor-grabbing"
