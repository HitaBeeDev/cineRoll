    ...
    <div className="flex min-w-0 items-center gap-2 sm:gap-3">
      {props.showReset && (
        <button
          ...
          className={cn(
            "inline-flex h-12 shrink-0 items-center justify-center gap-2 rounded-full border border-edge-strong px-4 sm:px-5",
            "font-[family-name:var(--font-geist-mono)] text-[10px] font-bold uppercase tracking-[0.12em] text-fg-hi sm:text-[11px] sm:tracking-widest",
      ...
      <button
        ...
        className={cn(
          ...
          "bg-accent font-[family-name:var(--font-geist-mono)] text-[10px] font-bold uppercase leading-4 tracking-[0.12em] text-fg-hi sm:text-xs sm:tracking-widest",
          "transition-colors hover:bg-[#d5342b] disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:bg-accent",
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-ink-900",
        )}
      >
        {props.isProcessing ? (
