...
export function TimelineSection({ viewModel }: { viewModel: StatsViewModel }) {
  ...
  return (
    <section className="scroll-mt-24">
      <SectionHeader eyebrow="The timeline" title="The archive through time" description="Each bar is a decade by film count — it opens on the densest era. Select any decade to explore its share, density, and defining film." actionHref="/browse?sort=newest" actionLabel="Browse by year" />
