  ...
  return (
    <div className="mx-auto max-w-4xl space-y-10 px-6 py-14 text-[#c8c8d8] lg:px-10">
      ...
      <PolicySection title="Data We Collect">
        <ul>
          <li>
            Account data: email address, display name, avatar, sign-in provider
            identifiers, session records, and email verification status.
          </li>
          <li>
            Film activity: watch history, watchlist entries, hidden or
            not-interested films, taste preferences, recommendations, and roll
            activity.
          </li>
          <li>
      ...
      <PolicySection title="Cookies and Local Storage">
        ...
        <ul>
          <li>
            <strong>authjs.session-token</strong> — essential. Keeps you signed
            in across pages; set only after you sign in.
          </li>
          <li>
            <strong>cineroll_onboarded</strong> — functional. Remembers that you
            finished onboarding so it is not shown again; expires after one
            year.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            <strong>cineroll_cookie_consent</strong> — stores your cookie-consent
            choice.
          </li>
          <li>
            <strong>cineroll-a2hs-dismissed-at</strong> — remembers when you
            dismissed the &quot;Add to Home Screen&quot; install prompt so it is
      ...
      <PolicySection title="Retention">
        <ul>
          ...
          <li>
            Feedback submissions are retained while they are useful for product
            planning, support, and abuse prevention.
          </li>
          <li>
      ...
      <PolicySection title="Deletion Process">
        <p>
          ...
          request through the feedback form with the same account email. We may
          ask you to verify account ownership before deleting data.
        </p>
        <p>
