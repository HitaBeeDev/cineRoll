  ...
  return (
    <div className="mx-auto max-w-4xl space-y-10 px-6 py-14 text-[#c8c8d8] lg:px-10">
      <PolicySection title="Overview">
        <p>
          CineRoll is a film discovery and tracking app. By creating an account or using the app,
          you agree to these terms. If you do not agree, please do not use CineRoll.
        </p>
      </PolicySection>
      ...
      <PolicySection title="Acceptable Use">
        ...
        <ul>
          ...
          <li>
            ...
            access to the service or its data.
          </li>
          <li>Use the app to violate any applicable law or the rights of others.</li>
        </ul>
      </PolicySection>
      ...
      <PolicySection title="Accounts">
        <ul>
          <li>
            You are responsible for activity under your account and for keeping your sign-in access
            secure.
          </li>
          <li>
            You must provide accurate information and be permitted to use the sign-in provider you
            connect.
          </li>
          <li>
      ...
      <PolicySection title="Film Data and Third-Party Trademarks">
        <p>
          CineRoll is an independent project and is <strong>not affiliated with, endorsed by, or
          sponsored by</strong> TMDB, OMDB, IMDb, Rotten Tomatoes, the Academy of Motion Picture Arts
          and Sciences (the Oscars), the Hollywood Foreign Press Association (the Golden Globes),
          the Festival de Cannes, the Berlin International Film Festival, or any studio,
          distributor, or awarding body.
        </p>
        <p>
          Film metadata, posters, and reference data are provided by third-party sources including
          TMDB and OMDB and remain the property of their respective owners. All film titles, awards,
          logos, and related trademarks belong to their respective holders and are used for
      ...
      <PolicySection title="Disclaimer and Liability">
        <p>
          CineRoll is provided &quot;as is&quot; and &quot;as available&quot; without warranties
          of any kind. We do not guarantee that film data, ratings, or recommendations are accurate,
          complete, or uninterrupted. To the maximum extent permitted by law, CineRoll is not liable
      ...
      <PolicySection title="Changes to These Terms">
        <p>
          We may update these terms as the app evolves. Continued use of CineRoll after changes take
          effect means you accept the updated terms. The date at the top reflects the latest
          revision.
        </p>
      </PolicySection>
      ...
      <PolicySection title="Contact">
        <p>
          For questions about these terms, use the feedback form at the bottom of the page and
          include the email address connected to your account.
        </p>
      </PolicySection>
    </div>
  );
